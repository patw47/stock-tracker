(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`n8n@2.20.10`}}catch{}})();try{(function(){var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{},t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`66b67b07-2d1f-4180-9e9c-c13f000256f3`,e._sentryDebugIdIdentifier=`sentry-dbid-66b67b07-2d1f-4180-9e9c-c13f000256f3`)})()}catch{}import{Ft as e,Nt as t,S as n}from"./vue.runtime.esm-bundler-D_yZoh5k.js";import{at as r,v as i}from"./core-BRsuS74k.js";import{lt as a,ut as o}from"./src-Hv_-DGWn.js";import{Xt as s,at as c,qt as l,s as u,t as d}from"./users.store-CpbECRNU.js";import{t as f}from"./useToast-BSNLKBfz.js";import{Gs as p,el as m,is as h,zr as g}from"./constants-DEcjX7rm.js";import{T as _}from"./useRootStore-CfBbjnPV.js";import{In as v,t as y}from"./settings.store-D3ibO8eV.js";import{t as b}from"./cloudPlan.store-BLL27OZk.js";import{t as x}from"./folders.store-DMIp9aiM.js";var S={name:`AI Agent workflow`,meta:{templateId:`ready-to-run-ai-workflow`},nodes:[{parameters:{url:`https://www.theverge.com/rss/index.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[128,448],id:`a26f16ce-82a5-4392-a032-622467e0098f`,name:`Get Tech News`},{parameters:{toolDescription:`Reads the news`,url:`=https://feeds.bbci.co.uk/news/world/rss.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[272,448],id:`91d1a929-b913-4399-977a-4306fe8349c7`,name:`Get World News`},{parameters:{model:{__rl:!0,mode:`list`,value:`gpt-4.1-mini`},options:{}},type:`@n8n/n8n-nodes-langchain.lmChatOpenAi`,typeVersion:1.2,position:[-144,448],id:`482c5e90-74ea-424c-9ec3-1dc14dd460f9`,name:`OpenAI Model`,notesInFlow:!0,credentials:{},notes:`Free n8n credits `},{parameters:{promptType:`define`,text:`=Provide a summary of world and tech news from the last 24 hours. 
...
Today is {{ $today }}
`}},type:`@n8n/n8n-nodes-langchain.agent`,typeVersion:3,position:[192,64],id:`ce5dd204-b9d3-4455-ab0c-0c2ce314ad52`,name:`AI Agent`}],pinData:{},connections:{"When chat message received":{main:[[{node:`AI Agent`,type:`main`,index:0}]]},"OpenAI Model":{ai_languageModel:[[{node:`AI Agent`,type:`ai_languageModel`,index:0}]]},"Simple Memory":{ai_memory:[[{node:`AI Agent`,type:`ai_memory`,index:0}]]},Hackernews:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},TheVerge:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"BBC News":{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"Google Sheets":{ai_tool:[[]]}}},D=_(v.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2,()=>{let e=s(),t=b(),r=n(()=>e.getVariant(m.name)),i=n(()=>r.value===m.variant5),a=n(()=>r.value===m.variant6),o=n(()=>t.userIsTrialing&&(i.value||a.value));return{currentVariant:r,getWorkflowForVariant:()=>{if(o.value){if(i.value)return T;if(a.value)return E}},isFeatureEnabled:o}}),O=`N8N_READY_TO_RUN_OPENAI_CREDENTIAL_ID`,k=_(v.READY_TO_RUN,()=>{let t=[`ready-to-run-ai-workflow`,`ready-to-run-ai-workflow-v5`,`ready-to-run-ai-workflow-v6`],a=l(),s=r(),m=f(),_=o(),v=c(),b=d(),x=y(),C=u(),T=D(),E=i(O,``),k=e(!1),A=n(()=>!!v.allCredentials.filter(e=>e.type===p).length),j=n(()=>!!b.currentUser?.settings?.userClaimedAiCredits),M=n(()=>x.isAiCreditsEnabled&&!A.value&&!j.value),N=e=>{a.track(`User executed ready to run AI workflow`,{status:e})},P=()=>{a.track(`User executed ready to run AI workflow successfully`)},F=async e=>{k.value=!0;try{let t=await v.claimFreeAiCredits(e);return E.value=t.id,a.track(`User claimed OpenAI credits`),t}catch(e){throw m.showError(e,s.baseText(`freeAi.credits.showError.claim.title`),{message:s.baseText(`freeAi.credits.showError.claim.message`)}),e}finally{k.value=!1}},I=()=>T.getWorkflowForVariant()??S,L=async(e,t)=>{a.track(`User opened ready to run AI workflow`,{source:e});try{let e={...I(),parentFolderId:t},n=E.value;if(n&&e.nodes){let t=h(e),r=t.nodes?.find(e=>e.name===`OpenAI Model`);r&&(r.credentials??={},r.credentials[p]={id:n,name:``}),e=t}let r=await C.createNewWorkflow(e);return await _.push({name:g.WORKFLOW,params:{workflowId:r.id}}),r}catch(e){throw m.showError(e,s.baseText(`generic.error`)),e}},R=async(e,t,n)=>{await F(n),await L(e,t),b?.currentUser?.settings&&(b.currentUser.settings.userClaimedAiCredits=!0)},z=(e,t)=>M.value&&!t&&e,B=(e,t,n)=>M.value&&!n&&t&&e,{isTrulyEmpty:V}=w();return{claimingCredits:k,userCanClaimOpenAiCredits:M,claimFreeAiCredits:F,createAndOpenAiWorkflow:L,claimCreditsAndOpenWorkflow:R,getCardVisibility:z,getButtonVisibility:B,getSimplifiedLayoutVisibility:e=>V(e),trackExecuteAiWorkflow:N,trackExecuteAiWorkflowSuccess:P,isReadyToRunTemplateId:e=>!!e&&t.includes(e)}});export{S as a,C as i,T as n,w as r,k as t};
//# sourceMappingURL=readyToRun.store-uNfW4AfQ.js.map